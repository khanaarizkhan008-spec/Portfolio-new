...
async function main() {
  ...
  await prisma.profile.upsert({
    ...
    create: {
      id: 'profile-1',
      name: 'Rizz Khan',
      role: 'B.Tech Computer Science student & builder',
      bio: 'Building AI-powered tools and full-stack apps across hackathons and coursework — GenAI applications, real-time SaaS platforms, and developer tooling.',
