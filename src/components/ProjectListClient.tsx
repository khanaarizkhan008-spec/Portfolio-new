  ...
  return (
    <div className="space-y-10 w-full">
        ...
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
          ...
          <div className="relative flex-1 max-w-2xl">
            ...
            <input
              ...
              className="w-full pl-11 pr-10 py-3.5 rounded-2xl bg-zinc-900/90 border border-white/10 text-white placeholder-zinc-500 text-sm focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all font-mono shadow-xl"
            />
            {searchQuery && (
              <button
          ...
          <div className="flex items-center gap-2 font-mono">
            <div className="relative">
              ...
              <select
                ...
                className="pl-10 pr-8 py-3.5 rounded-2xl bg-zinc-900/90 border border-white/10 text-white text-xs font-bold uppercase tracking-wider focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all cursor-pointer shadow-xl appearance-none"
              >
      ...
      {filteredProjects.length === 0 ? (
        <div className="p-16 rounded-3xl bg-zinc-900/60 border border-white/10 text-center space-y-4">
                      ...
                      {project.tags.split(",").map((tag) => {
                        ...
                        return (
                          <button
                            ...
                            className="text-xs px-3 py-1 rounded-md bg-white/5 text-zinc-300 hover:text-white hover:bg-white/10 border border-white/10 font-medium transition-colors cursor-pointer"
                          >
                            {trimmed}
                          </button>
                        );
